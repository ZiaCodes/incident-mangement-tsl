  ...
  return (
    <MainContainer>
        <div className="container mx-auto px-4 sm:px-8">
            <div className="py-8">
                <div>
                <h2 className="text-2xl font-semibold leading-tight">My Watch-List</h2>
                </div>
                ...
                >
                    ...
                    <tbody>
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap">7 Days</p>
                            <p className="text-gray-600 whitespace-no-wrap">Above 3</p>
                        </td>
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap">SKYLINK</p>
                            <p className="text-gray-600 whitespace-no-wrap">Jamshedpur</p>
                        </td>
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <span
